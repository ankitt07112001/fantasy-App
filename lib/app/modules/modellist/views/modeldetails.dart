...
class Modeldetails extends GetView<ModellistController> {
      ...
      children: [
        Row(
          ...
          children: [
            ...
            Container(
              decoration:
                  BoxDecoration(borderRadius: BorderRadius.circular(10.0), color: controller.appColors.appColor),
              child: Row(
          ...
          children: [
            Container(
              decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(10.0), color: controller.appColors.lightpink.withOpacity(0.3)),
              child: Row(
                children: [
                  Image.asset(
                    ImagePath.coinimg,
            ...
            Row(
              children: [
                ...
                Container(
                  decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(6.0), color: controller.appColors.lightpink.withOpacity(0.3)),
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    crossAxisAlignment: CrossAxisAlignment.center,
                    children: [
