...
class AppColors {
  ...
  Color txtblack = const Color(0xFF212121);
  Color linearGradient1 = const Color(0xFFFB6666);
  Color linearGradient2 = const Color(0xFFFFB0B0);
  Color border = const Color(0xFFDADADA);
  Color white = const Color(0xFFFFFFFF);
  Color txtwhite = const Color(0xFFFFFFFF);
  Color lightgrey = const Color(0xFF5A5B5B);
  Color lightergrey = const Color(0xFFB9B8BB);
  Color lightpink = const Color(0xFFFF9E9E);
  Color yellow = const Color(0xFFFF9213);
  Color darkblue = const Color(0xFF200B30);
  Color lightblue = const Color(0xFF1A59A4);
  Color darkpink = const Color(0xFFE0688E);
  Color lightBlack = const Color(0xFFD7D7D7);
